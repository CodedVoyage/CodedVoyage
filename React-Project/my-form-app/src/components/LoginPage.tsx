...
//                            <p>Don't have an account? <a href="/register" className="text-decoration-none" style={{ color: '#0586C8' }}>Register here</a></p>
//                        </div>
//                    </div>
//                </div>
//            </div>
...
const LoginPage = () => {
    ...
    const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (user) {
            ...
            dispatch({ type: 'LOGIN_SUCCESS', payload: { id: user.id, username: user.username } });
            setError('');
            navigate('/Dashboard');
        } else {
